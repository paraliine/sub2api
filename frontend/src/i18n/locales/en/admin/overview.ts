export default {
    ...
    groups: {
      ...
      subscription: {
        ...
        quotaSourceAccount: 'Quota Source Account',
        noQuotaSourceAccount: 'No source account',
        loadingQuotaSourceAccounts: 'Loading accounts...',
        quotaSourceAccountHint: 'Selecting one also binds the account to this group for official daily/weekly reset tracking.',
        officialFiveHourLimit: 'Official 5h Total (not cycle-synced)',
        officialDailyLimit: 'Official Daily Total',
        officialWeeklyLimit: 'Official 7d Total',
        allocationEqual: 'Allocation: equal split across active subscription users',
        followOfficialReset: 'Cycle sync: follow official reset',
        followOfficialResetHint: 'Detect an official reset when the source account daily/weekly usage drops. The 5h window still resets with the subscription window logic.',
        lagReconcileAuto: 'Lag reconciliation: subtract usage consumed during the detection window',
        lagReconcileAutoHint: 'After a reset is detected, count usage since the previous check into the new cycle.',
        quotaCheckInterval: 'Official quota check interval (minutes)',
        quotaCheckIntervalHint: 'Default is 10 minutes. Smaller values reduce the reconciliation lag window.',
