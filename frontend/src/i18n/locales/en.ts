  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        quotaSourceAccountHint: 'Selecting one also binds the account to this group for official reset tracking.',
        officialFiveHourLimit: 'Official 5h Total',
        ...
        followOfficialResetHint: 'Detect an official reset when the source account usage drops.',
