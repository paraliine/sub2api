export default {
    ...
    groups: {
      ...
      subscription: {
        ...
        quotaSourceAccount: '额度来源账号',
        noQuotaSourceAccount: '不绑定来源账号',
        loadingQuotaSourceAccounts: '正在加载账号...',
        quotaSourceAccountHint: '选择后该账号会自动绑定到当前分组，用于跟随官方日/周额度重置。',
        officialFiveHourLimit: '官方 5h 总额度（不参与周期同步）',
        officialDailyLimit: '官方日总额度',
        officialWeeklyLimit: '官方 7d 总额度',
        allocationEqual: '分配方式：活跃订阅用户均分',
        followOfficialReset: '周期同步：跟随官方重置',
        followOfficialResetHint: '当来源账号官方日/周已用量下降时，判定官方进入新周期。5 小时窗口仍按订阅自身逻辑重置。',
        lagReconcileAuto: '滞后对账：自动扣除检测期间已消耗额度',
        lagReconcileAutoHint: '检测到重置后，把上次检查以来的用量计入新周期。',
        quotaCheckInterval: '官方额度检查频率（分钟）',
        quotaCheckIntervalHint: '默认 10 分钟。数值越小，重置滞后对账窗口越短。',
