...
func (r *groupRepository) CreateFromSource(ctx context.Context, groupIn *service.Group, sourceGroupID int64) error {
	...
	if err := updateQuotaSourceConfig(ctx, txClient, groupIn); err != nil {
		return err
	}
...
func (r *groupRepository) updateQuotaSourceConfig(ctx context.Context, groupIn *service.Group) error {
	return updateQuotaSourceConfig(ctx, r.sql, groupIn)
}

func updateQuotaSourceConfig(ctx context.Context, executor sqlExecutor, groupIn *service.Group) error {
